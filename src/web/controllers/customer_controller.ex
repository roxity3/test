defmodule Ewms.CustomerController do
  ...
  def create(conn, %{"customer" => customer_params}) do
    ...
    case Repo.insert(changeset) do
      {:ok, _customer} ->
        conn
        |> put_flash(:info, "Se creó correctamente el cliente.")
  ...
  def update(conn, %{"id" => id, "customer" => customer_params}) do
    ...
    case Repo.update(changeset) do
      {:ok, customer} ->
        conn
        |> put_flash(:info, "Se actualizaron los datos del cliente.")
  ...
  def delete(conn, %{"id" => id}) do
    ...
    conn
    |> put_flash(:info, "Se eliminaron los datos del cliente.")
    |> redirect(to: customer_path(conn, :index))
  end
end
